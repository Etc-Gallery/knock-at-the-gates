...
},x.offset={setOffset:function(e,t,n){var r,i,o,s,a,u,l,c=x.css(e,"position"),p=x(e),f={};"static"===c&&(e.style.position="relative"),a=p.offset(),o=x.css(e,"top"),u=x.css(e,"left"),l=("absolute"===c||"fixed"===c)&&(o+u).indexOf("auto")>-1,l?(r=p.position(),s=r.top,i=r.left):(s=parseFloat(o)||0,i=parseFloat(u)||0),x.isFunction(t)&&(t=t.call(e,n,a)),null!=t.top&&(f.top=t.top-a.top+s),null!=t.left&&(f.left=t.left-a.left+i),"using"in t?t.using.call(e,f):p.css(f)}},x.fn.extend({position:function(){if(this[0]){var e,t,n=this[0],r={top:0,left:0};return"fixed"===x.css(n,"position")?t=n.getBoundingClientRect():(e=this.offsetParent(),t=this.offset(),x.nodeName(e[0],"html")||(r=e.offset()),r.top+=x.css(e[0],"borderTopWidth",!0),r.left+=x.css(e[0],"borderLeftWidth",!0)),{top:t.top-r.top-x.css(n,"marginTop",!0),left:t.left-r.left-x.css(n,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){var e=this.offsetParent||s;while(e&&!x.nodeName(e,"html")&&"static"===x.css(e,"position"))e=e.offsetParent;return e||s})}}),x.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(t,n){var r="pageYOffset"===n;x.fn[t]=function(i){return x.access(this,function(t,i,o){var s=Hn(t);return o===undefined?s?s[n]:t[i]:(s?s.scrollTo(r?e.pageXOffset:o,r?o:e.pageYOffset):t[i]=o,undefined)},t,i,arguments.length,null)}});function Hn(e){return x.isWindow(e)?e:9===e.nodeType&&e.defaultView}x.each({Height:"height",Width:"width"},function(e,t){x.each({padding:"inner"+e,content:t,"":"outer"+e},function(n,r){x.fn[r]=function(r,i){var o=arguments.length&&(n||"boolean"!=typeof r),s=n||(r===!0||i===!0?"margin":"border");return x.access(this,function(t,n,r){var i;return x.isWindow(t)?t.document.documentElement["client"+e]:9===t.nodeType?(i=t.documentElement,Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):r===undefined?x.css(t,n,s):x.style(t,n,r,s)},t,o?r:undefined,o,null)}})}),x.fn.size=function(){return this.length},x.fn.andSelf=x.fn.addBack,"object"==typeof module&&module&&"object"==typeof module.exports?module.exports=x:"function"==typeof define&&define.amd&&define("jquery",[],function(){return x}),"object"==typeof e&&"object"==typeof e.document&&(e.jQuery=e.$=x)})(window);!function(){var topojson={version:"1.6.15",mesh:function(topology){return object(topology,meshArcs.apply(this,arguments))},meshArcs:meshArcs,merge:function(topology){return object(topology,mergeArcs.apply(this,arguments))},mergeArcs:mergeArcs,feature:featureOrCollection,neighbors:neighbors,presimplify:presimplify};function stitchArcs(topology,arcs){var stitchedArcs={},fragmentByStart={},fragmentByEnd={},fragments=[],emptyIndex=-1;arcs.forEach(function(i,j){var arc=topology.arcs[i<0?~i:i],t;if(arc.length<3&&!arc[1][0]&&!arc[1][1]){t=arcs[++emptyIndex],arcs[emptyIndex]=i,arcs[j]=t}});arcs.forEach(function(i){var e=ends(i),start=e[0],end=e[1],f,g;if(f=fragmentByEnd[start]){delete fragmentByEnd[f.end];f.push(i);f.end=end;if(g=fragmentByStart[end]){delete fragmentByStart[g.start];var fg=g===f?f:f.concat(g);fragmentByStart[fg.start=f.start]=fragmentByEnd[fg.end=g.end]=fg}else{fragmentByStart[f.start]=fragmentByEnd[f.end]=f}}else if(f=fragmentByStart[end]){delete fragmentByStart[f.start];f.unshift(i);f.start=start;if(g=fragmentByEnd[start]){delete fragmentByEnd[g.end];var gf=g===f?f:g.concat(f);fragmentByStart[gf.start=g.start]=fragmentByEnd[gf.end=f.end]=gf}else{fragmentByStart[f.start]=fragmentByEnd[f.end]=f}}else{f=[i];fragmentByStart[f.start=start]=fragmentByEnd[f.end=end]=f}});function ends(i){var arc=topology.arcs[i<0?~i:i],p0=arc[0],p1;if(topology.transform)p1=[0,0],arc.forEach(function(dp){p1[0]+=dp[0],p1[1]+=dp[1]});else p1=arc[arc.length-1];return i<0?[p1,p0]:[p0,p1]}function flush(fragmentByEnd,fragmentByStart){for(var k in fragmentByEnd){var f=fragmentByEnd[k];delete fragmentByStart[f.start];delete f.start;delete f.end;f.forEach(function(i){stitchedArcs[i<0?~i:i]=1});fragments.push(f)}}flush(fragmentByEnd,fragmentByStart);flush(fragmentByStart,fragmentByEnd);arcs.forEach(function(i){if(!stitchedArcs[i<0?~i:i])fragments.push([i])});return fragments}function meshArcs(topology,o,filter){var arcs=[];if(arguments.length>1){var geomsByArc=[],geom;function arc(i){var j=i<0?~i:i;(geomsByArc[j]||(geomsByArc[j]=[])).push({i:i,g:geom})}function line(arcs){arcs.forEach(arc)}function polygon(arcs){arcs.forEach(line)}function geometry(o){if(o.type==="GeometryCollection")o.geometries.forEach(geometry);else if(o.type in geometryType)geom=o,geometryType[o.type](o.arcs)}var geometryType={LineString:line,MultiLineString:polygon,Polygon:polygon,MultiPolygon:function(arcs){arcs.forEach(polygon)}};geometry(o);geomsByArc.forEach(arguments.length<3?function(geoms){arcs.push(geoms[0].i)}:function(geoms){if(filter(geoms[0].g,geoms[geoms.length-1].g))arcs.push(geoms[0].i)})}else{for(var i=0,n=topology.arcs.length;i<n;++i)arcs.push(i)}return{type:"MultiLineString",arcs:stitchArcs(topology,arcs)}}function mergeArcs(topology,objects){var polygonsByArc={},polygons=[],components=[];objects.forEach(function(o){if(o.type==="Polygon")register(o.arcs);else if(o.type==="MultiPolygon")o.arcs.forEach(register)});function register(polygon){polygon.forEach(function(ring){ring.forEach(function(arc){(polygonsByArc[arc=arc<0?~arc:arc]||(polygonsByArc[arc]=[])).push(polygon)})});polygons.push(polygon)}function exterior(ring){return cartesianRingArea(object(topology,{type:"Polygon",arcs:[ring]}).coordinates[0])>0}polygons.forEach(function(polygon){if(!polygon._){var component=[],neighbors=[polygon];polygon._=1;components.push(component);while(polygon=neighbors.pop()){component.push(polygon);polygon.forEach(function(ring){ring.forEach(function(arc){polygonsByArc[arc<0?~arc:arc].forEach(function(polygon){if(!polygon._){polygon._=1;neighbors.push(polygon)}})})})}}});polygons.forEach(function(polygon){delete polygon._});return{type:"MultiPolygon",arcs:components.map(function(polygons){var arcs=[];polygons.forEach(function(polygon){polygon.forEach(function(ring){ring.forEach(function(arc){if(polygonsByArc[arc<0?~arc:arc].length<2){arcs.push(arc)}})})});arcs=stitchArcs(topology,arcs);if((n=arcs.length)>1){var sgn=exterior(polygons[0][0]);for(var i=0,t;i<n;++i){if(sgn===exterior(arcs[i])){t=arcs[0],arcs[0]=arcs[i],arcs[i]=t;break}}}return arcs})}}function featureOrCollection(topology,o){return o.type==="GeometryCollection"?{type:"FeatureCollection",features:o.geometries.map(function(o){return feature(topology,o)})}:feature(topology,o)}function feature(topology,o){var f={type:"Feature",id:o.id,properties:o.properties||{},geometry:object(topology,o)};if(o.id==null)delete f.id;return f}function object(topology,o){var absolute=transformAbsolute(topology.transform),arcs=topology.arcs;function arc(i,points){if(points.length)points.pop();for(var a=arcs[i<0?~i:i],k=0,n=a.length,p;k<n;++k){points.push(p=a[k].slice());absolute(p,k)}if(i<0)reverse(points,n)}function point(p){p=p.slice();absolute(p,0);return p}function line(arcs){var points=[];for(var i=0,n=arcs.length;i<n;++i)arc(arcs[i],points);if(points.length<2)points.push(points[0].slice());return points}function ring(arcs){var points=line(arcs);while(points.length<4)points.push(points[0].slice());return points}function polygon(arcs){return arcs.map(ring)}function geometry(o){var t=o.type;return t==="GeometryCollection"?{type:t,geometries:o.geometries.map(geometry)}:t in geometryType?{type:t,coordinates:geometryType[t](o)}:null}var geometryType={Point:function(o){return point(o.coordinates)},MultiPoint:function(o){return o.coordinates.map(point)},LineString:function(o){return line(o.arcs)},MultiLineString:function(o){return o.arcs.map(line)},Polygon:function(o){return polygon(o.arcs)},MultiPolygon:function(o){return o.arcs.map(polygon)}};return geometry(o)}function reverse(array,n){var t,j=array.length,i=j-n;while(i<--j)t=array[i],array[i++]=array[j],array[j]=t}function bisect(a,x){var lo=0,hi=a.length;while(lo<hi){var mid=lo+hi>>>1;if(a[mid]<x)lo=mid+1;else hi=mid}return lo}function neighbors(objects){var indexesByArc={},neighbors=objects.map(function(){return[]});function line(arcs,i){arcs.forEach(function(a){if(a<0)a=~a;var o=indexesByArc[a];if(o)o.push(i);else indexesByArc[a]=[i]})}function polygon(arcs,i){arcs.forEach(function(arc){line(arc,i)})}function geometry(o,i){if(o.type==="GeometryCollection")o.geometries.forEach(function(o){geometry(o,i)});else if(o.type in geometryType)geometryType[o.type](o.arcs,i)}var geometryType={LineString:line,MultiLineString:polygon,Polygon:polygon,MultiPolygon:function(arcs,i){arcs.forEach(function(arc){polygon(arc,i)})}};objects.forEach(geometry);for(var i in indexesByArc){for(var indexes=indexesByArc[i],m=indexes.length,j=0;j<m;++j){for(var k=j+1;k<m;++k){var ij=indexes[j],ik=indexes[k],n;if((n=neighbors[ij])[i=bisect(n,ik)]!==ik)n.splice(i,0,ik);if((n=neighbors[ik])[i=bisect(n,ij)]!==ij)n.splice(i,0,ij)}}}return neighbors}function presimplify(topology,triangleArea){var absolute=transformAbsolute(topology.transform),relative=transformRelative(topology.transform),heap=minAreaHeap();if(!triangleArea)triangleArea=cartesianTriangleArea;topology.arcs.forEach(function(arc){var triangles=[],maxArea=0,triangle;arc.forEach(absolute);for(var i=1,n=arc.length-1;i<n;++i){triangle=arc.slice(i-1,i+2);triangle[1][2]=triangleArea(triangle);triangles.push(triangle);heap.push(triangle)}arc[0][2]=arc[n][2]=Infinity;for(var i=0,n=triangles.length;i<n;++i){triangle=triangles[i];triangle.previous=triangles[i-1];triangle.next=triangles[i+1]}while(triangle=heap.pop()){var previous=triangle.previous,next=triangle.next;if(triangle[1][2]<maxArea)triangle[1][2]=maxArea;else maxArea=triangle[1][2];if(previous){previous.next=next;previous[2]=triangle[2];update(previous)}if(next){next.previous=previous;next[0]=triangle[0];update(next)}}arc.forEach(relative)});function update(triangle){heap.remove(triangle);triangle[1][2]=triangleArea(triangle);heap.push(triangle)}return topology}function cartesianRingArea(ring){var i=-1,n=ring.length,a,b=ring[n-1],area=0;while(++i<n){a=b;b=ring[i];area+=a[0]*b[1]-a[1]*b[0]}return area*.5}function cartesianTriangleArea(triangle){var a=triangle[0],b=triangle[1],c=triangle[2];return Math.abs((a[0]-c[0])*(b[1]-a[1])-(a[0]-b[0])*(c[1]-a[1]))}function compareArea(a,b){return a[1][2]-b[1][2]}function minAreaHeap(){var heap={},array=[],size=0;heap.push=function(object){up(array[object._=size]=object,size++);return size};heap.pop=function(){if(size<=0)return;var removed=array[0],object;if(--size>0)object=array[size],down(array[object._=0]=object,0);return removed};heap.remove=function(removed){var i=removed._,object;if(array[i]!==removed)return;if(i!==--size)object=array[size],(compareArea(object,removed)<0?up:down)(array[object._=i]=object,i);return i};function up(object,i){while(i>0){var j=(i+1>>1)-1,parent=array[j];if(compareArea(object,parent)>=0)break;array[parent._=i]=parent;array[object._=i=j]=object}}function down(object,i){while(true){var r=i+1<<1,l=r-1,j=i,child=array[j];if(l<size&&compareArea(array[l],child)<0)child=array[j=l];if(r<size&&compareArea(array[r],child)<0)child=array[j=r];if(j===i)break;array[child._=i]=child;array[object._=i=j]=object}}return heap}function transformAbsolute(transform){if(!transform)return noop;var x0,y0,kx=transform.scale[0],ky=transform.scale[1],dx=transform.translate[0],dy=transform.translate[1];return function(point,i){if(!i)x0=y0=0;point[0]=(x0+=point[0])*kx+dx;point[1]=(y0+=point[1])*ky+dy}}function transformRelative(transform){if(!transform)return noop;var x0,y0,kx=transform.scale[0],ky=transform.scale[1],dx=transform.translate[0],dy=transform.translate[1];return function(point,i){if(!i)x0=y0=0;var x1=(point[0]-dx)/kx|0,y1=(point[1]-dy)/ky|0;point[0]=x1-x0;point[1]=y1-y0;x0=x1;y0=y1}}function noop(){}if(typeof define==="function"&&define.amd)define(topojson);else if(typeof module==="object"&&module.exports)module.exports=topojson;else this.topojson=topojson}();!function(){var n=this,t=n._,r={},e=Array.prototype,u=Object.prototype,i=Function.prototype,a=e.push,o=e.slice,c=e.concat,l=u.toString,f=u.hasOwnProperty,s=e.forEach,p=e.map,v=e.reduce,h=e.reduceRight,d=e.filter,g=e.every,m=e.some,y=e.indexOf,b=e.lastIndexOf,x=Array.isArray,_=Object.keys,w=i.bind,j=function(n){return n instanceof j?n:this instanceof j?(this._wrapped=n,void 0):new j(n)};"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=j),exports._=j):n._=j,j.VERSION="1.5.1";var A=j.each=j.forEach=function(n,t,e){if(null!=n)if(s&&n.forEach===s)n.forEach(t,e);else if(n.length===+n.length){for(var u=0,i=n.length;i>u;u++)if(t.call(e,n[u],u,n)===r)return}else for(var a in n)if(j.has(n,a)&&t.call(e,n[a],a,n)===r)return};j.map=j.collect=function(n,t,r){var e=[];return null==n?e:p&&n.map===p?n.map(t,r):(A(n,function(n,u,i){e.push(t.call(r,n,u,i))}),e)};var E="Reduce of empty array with no initial value";j.reduce=j.foldl=j.inject=function(n,t,r,e){var u=arguments.length>2;if(null==n&&(n=[]),v&&n.reduce===v)return e&&(t=j.bind(t,e)),u?n.reduce(t,r):n.reduce(t);if(A(n,function(n,i,a){u?r=t.call(e,r,n,i,a):(r=n,u=!0)}),!u)throw new TypeError(E);return r},j.reduceRight=j.foldr=function(n,t,r,e){var u=arguments.length>2;if(null==n&&(n=[]),h&&n.reduceRight===h)return e&&(t=j.bind(t,e)),u?n.reduceRight(t,r):n.reduceRight(t);var i=n.length;if(i!==+i){var a=j.keys(n);i=a.length}if(A(n,function(o,c,l){c=a?a[--i]:--i,u?r=t.call(e,r,n[c],c,l):(r=n[c],u=!0)}),!u)throw new TypeError(E);return r},j.find=j.detect=function(n,t,r){var e;return O(n,function(n,u,i){return t.call(r,n,u,i)?(e=n,!0):void 0}),e},j.filter=j.select=function(n,t,r){var e=[];return null==n?e:d&&n.filter===d?n.filter(t,r):(A(n,function(n,u,i){t.call(r,n,u,i)&&e.push(n)}),e)},j.reject=function(n,t,r){return j.filter(n,function(n,e,u){return!t.call(r,n,e,u)},r)},j.every=j.all=function(n,t,e){t||(t=j.identity);var u=!0;return null==n?u:g&&n.every===g?n.every(t,e):(A(n,function(n,i,a){return(u=u&&t.call(e,n,i,a))?void 0:r}),!!u)};var O=j.some=j.any=function(n,t,e){t||(t=j.identity);var u=!1;return null==n?u:m&&n.some===m?n.some(t,e):(A(n,function(n,i,a){return u||(u=t.call(e,n,i,a))?r:void 0}),!!u)};j.contains=j.include=function(n,t){return null==n?!1:y&&n.indexOf===y?n.indexOf(t)!=-1:O(n,function(n){return n===t})},j.invoke=function(n,t){var r=o.call(arguments,2),e=j.isFunction(t);return j.map(n,function(n){return(e?t:n[t]).apply(n,r)})},j.pluck=function(n,t){return j.map(n,function(n){return n[t]})},j.where=function(n,t,r){return j.isEmpty(t)?r?void 0:[]:j[r?"find":"filter"](n,function(n){for(var r in t)if(t[r]!==n[r])return!1;return!0})},j.findWhere=function(n,t){return j.where(n,t,!0)},j.max=function(n,t,r){if(!t&&j.isArray(n)&&n[0]===+n[0]&&n.length<65535)return Math.max.apply(Math,n);if(!t&&j.isEmpty(n))return-1/0;var e={computed:-1/0,value:-1/0};return A(n,function(n,u,i){var a=t?t.call(r,n,u,i):n;a>e.computed&&(e={value:n,computed:a})}),e.value},j.min=function(n,t,r){if(!t&&j.isArray(n)&&n[0]===+n[0]&&n.length<65535)return Math.min.apply(Math,n);if(!t&&j.isEmpty(n))return 1/0;var e={computed:1/0,value:1/0};return A(n,function(n,u,i){var a=t?t.call(r,n,u,i):n;a<e.computed&&(e={value:n,computed:a})}),e.value},j.shuffle=function(n){var t,r=0,e=[];return A(n,function(n){t=j.random(r++),e[r-1]=e[t],e[t]=n}),e};var F=function(n){return j.isFunction(n)?n:function(t){return t[n]}};j.sortBy=function(n,t,r){var e=F(t);return j.pluck(j.map(n,function(n,t,u){return{value:n,index:t,criteria:e.call(r,n,t,u)}}).sort(function(n,t){var r=n.criteria,e=t.criteria;if(r!==e){if(r>e||r===void 0)return 1;if(e>r||e===void 0)return-1}return n.index<t.index?-1:1}),"value")};var k=function(n,t,r,e){var u={},i=F(null==t?j.identity:t);return A(n,function(t,a){var o=i.call(r,t,a,n);e(u,o,t)}),u};j.groupBy=function(n,t,r){return k(n,t,r,function(n,t,r){(j.has(n,t)?n[t]:n[t]=[]).push(r)})},j.countBy=function(n,t,r){return k(n,t,r,function(n,t){j.has(n,t)||(n[t]=0),n[t]++})},j.sortedIndex=function(n,t,r,e){r=null==r?j.identity:F(r);for(var u=r.call(e,t),i=0,a=n.length;a>i;){var o=i+a>>>1;r.call(e,n[o])<u?i=o+1:a=o}return i},j.toArray=function(n){return n?j.isArray(n)?o.call(n):n.length===+n.length?j.map(n,j.identity):j.values(n):[]},j.size=function(n){return null==n?0:n.length===+n.length?n.length:j.keys(n).length},j.first=j.head=j.take=function(n,t,r){return null==n?void 0:null==t||r?n[0]:o.call(n,0,t)},j.initial=function(n,t,r){return o.call(n,0,n.length-(null==t||r?1:t))},j.last=function(n,t,r){return null==n?void 0:null==t||r?n[n.length-1]:o.call(n,Math.max(n.length-t,0))},j.rest=j.tail=j.drop=function(n,t,r){return o.call(n,null==t||r?1:t)},j.compact=function(n){return j.filter(n,j.identity)};var R=function(n,t,r){return t&&j.every(n,j.isArray)?c.apply(r,n):(A(n,function(n){j.isArray(n)||j.isArguments(n)?t?a.apply(r,n):R(n,t,r):r.push(n)}),r)};j.flatten=function(n,t){return R(n,t,[])},j.without=function(n){return j.difference(n,o.call(arguments,1))},j.uniq=j.unique=function(n,t,r,e){j.isFunction(t)&&(e=r,r=t,t=!1);var u=r?j.map(n,r,e):n,i=[],a=[];return A(u,function(r,e){(t?e&&a[a.length-1]===r:j.contains(a,r))||(a.push(r),i.push(n[e]))}),i},j.union=function(){return j.uniq(j.flatten(arguments,!0))},j.intersection=function(n){var t=o.call(arguments,1);return j.filter(j.uniq(n),function(n){return j.every(t,function(t){return j.indexOf(t,n)>=0})})},j.difference=function(n){var t=c.apply(e,o.call(arguments,1));return j.filter(n,function(n){return!j.contains(t,n)})},j.zip=function(){for(var n=j.max(j.pluck(arguments,"length").concat(0)),t=new Array(n),r=0;n>r;r++)t[r]=j.pluck(arguments,""+r);return t},j.object=function(n,t){if(null==n)return{};for(var r={},e=0,u=n.length;u>e;e++)t?r[n[e]]=t[e]:r[n[e][0]]=n[e][1];return r},j.indexOf=function(n,t,r){if(null==n)return-1;var e=0,u=n.length;if(r){if("number"!=typeof r)return e=j.sortedIndex(n,t),n[e]===t?e:-1;e=0>r?Math.max(0,u+r):r}if(y&&n.indexOf===y)return n.indexOf(t,r);for(;u>e;e++)if(n[e]===t)return e;return-1},j.lastIndexOf=function(n,t,r){if(null==n)return-1;var e=null!=r;if(b&&n.lastIndexOf===b)return e?n.lastIndexOf(t,r):n.lastIndexOf(t);for(var u=e?r:n.length;u--;)if(n[u]===t)return u;return-1},j.range=function(n,t,r){arguments.length<=1&&(t=n||0,n=0),r=arguments[2]||1;for(var e=Math.max(Math.ceil((t-n)/r),0),u=0,i=new Array(e);e>u;)i[u++]=n,n+=r;return i};var M=function(){};j.bind=function(n,t){var r,e;if(w&&n.bind===w)return w.apply(n,o.call(arguments,1));if(!j.isFunction(n))throw new TypeError;return r=o.call(arguments,2),e=function(){if(!(this instanceof e))return n.apply(t,r.concat(o.call(arguments)));M.prototype=n.prototype;var u=new M;M.prototype=null;var i=n.apply(u,r.concat(o.call(arguments)));return Object(i)===i?i:u}},j.partial=function(n){var t=o.call(arguments,1);return function(){return n.apply(this,t.concat(o.call(arguments)))}},j.bindAll=function(n){var t=o.call(arguments,1);if(0===t.length)throw new Error("bindAll must be passed function names");return A(t,function(t){n[t]=j.bind(n[t],n)}),n},j.memoize=function(n,t){var r={};return t||(t=j.identity),function(){var e=t.apply(this,arguments);return j.has(r,e)?r[e]:r[e]=n.apply(this,arguments)}},j.delay=function(n,t){var r=o.call(arguments,2);return setTimeout(function(){return n.apply(null,r)},t)},j.defer=function(n){return j.delay.apply(j,[n,1].concat(o.call(arguments,1)))},j.throttle=function(n,t,r){var e,u,i,a=null,o=0;r||(r={});var c=function(){o=r.leading===!1?0:new Date,a=null,i=n.apply(e,u)};return function(){var l=new Date;o||r.leading!==!1||(o=l);var f=t-(l-o);return e=this,u=arguments,0>=f?(clearTimeout(a),a=null,o=l,i=n.apply(e,u)):a||r.trailing===!1||(a=setTimeout(c,f)),i}},j.debounce=function(n,t,r){var e,u=null;return function(){var i=this,a=arguments,o=function(){u=null,r||(e=n.apply(i,a))},c=r&&!u;return clearTimeout(u),u=setTimeout(o,t),c&&(e=n.apply(i,a)),e}},j.once=function(n){var t,r=!1;return function(){return r?t:(r=!0,t=n.apply(this,arguments),n=null,t)}},j.wrap=function(n,t){return function(){var r=[n];return a.apply(r,arguments),t.apply(this,r)}},j.compose=function(){var n=arguments;return function(){for(var t=arguments,r=n.length-1;r>=0;r--)t=[n[r].apply(this,t)];return t[0]}},j.after=function(n,t){return function(){return--n<1?t.apply(this,arguments):void 0}},j.keys=_||function(n){if(n!==Object(n))throw new TypeError("Invalid object");var t=[];for(var r in n)j.has(n,r)&&t.push(r);return t},j.values=function(n){var t=[];for(var r in n)j.has(n,r)&&t.push(n[r]);return t},j.pairs=function(n){var t=[];for(var r in n)j.has(n,r)&&t.push([r,n[r]]);return t},j.invert=function(n){var t={};for(var r in n)j.has(n,r)&&(t[n[r]]=r);return t},j.functions=j.methods=function(n){var t=[];for(var r in n)j.isFunction(n[r])&&t.push(r);return t.sort()},j.extend=function(n){return A(o.call(arguments,1),function(t){if(t)for(var r in t)n[r]=t[r]}),n},j.pick=function(n){var t={},r=c.apply(e,o.call(arguments,1));return A(r,function(r){r in n&&(t[r]=n[r])}),t},j.omit=function(n){var t={},r=c.apply(e,o.call(arguments,1));for(var u in n)j.contains(r,u)||(t[u]=n[u]);return t},j.defaults=function(n){return A(o.call(arguments,1),function(t){if(t)for(var r in t)n[r]===void 0&&(n[r]=t[r])}),n},j.clone=function(n){return j.isObject(n)?j.isArray(n)?n.slice():j.extend({},n):n},j.tap=function(n,t){return t(n),n};var S=function(n,t,r,e){if(n===t)return 0!==n||1/n==1/t;if(null==n||null==t)return n===t;n instanceof j&&(n=n._wrapped),t instanceof j&&(t=t._wrapped);var u=l.call(n);if(u!=l.call(t))return!1;switch(u){case"[object String]":return n==String(t);case"[object Number]":return n!=+n?t!=+t:0==n?1/n==1/t:n==+t;case"[object Date]":case"[object Boolean]":return+n==+t;case"[object RegExp]":return n.source==t.source&&n.global==t.global&&n.multiline==t.multiline&&n.ignoreCase==t.ignoreCase}if("object"!=typeof n||"object"!=typeof t)return!1;for(var i=r.length;i--;)if(r[i]==n)return e[i]==t;var a=n.constructor,o=t.constructor;if(a!==o&&!(j.isFunction(a)&&a instanceof a&&j.isFunction(o)&&o instanceof o))return!1;r.push(n),e.push(t);var c=0,f=!0;if("[object Array]"==u){if(c=n.length,f=c==t.length)for(;c--&&(f=S(n[c],t[c],r,e)););}else{for(var s in n)if(j.has(n,s)&&(c++,!(f=j.has(t,s)&&S(n[s],t[s],r,e))))break;if(f){for(s in t)if(j.has(t,s)&&!c--)break;f=!c}}return r.pop(),e.pop(),f};j.isEqual=function(n,t){return S(n,t,[],[])},j.isEmpty=function(n){if(null==n)return!0;if(j.isArray(n)||j.isString(n))return 0===n.length;for(var t in n)if(j.has(n,t))return!1;return!0},j.isElement=function(n){return!(!n||1!==n.nodeType)},j.isArray=x||function(n){return"[object Array]"==l.call(n)},j.isObject=function(n){return n===Object(n)},A(["Arguments","Function","String","Number","Date","RegExp"],function(n){j["is"+n]=function(t){return l.call(t)=="[object "+n+"]"}}),j.isArguments(arguments)||(j.isArguments=function(n){return!(!n||!j.has(n,"callee"))}),"function"!=typeof/./&&(j.isFunction=function(n){return"function"==typeof n}),j.isFinite=function(n){return isFinite(n)&&!isNaN(parseFloat(n))},j.isNaN=function(n){return j.isNumber(n)&&n!=+n},j.isBoolean=function(n){return n===!0||n===!1||"[object Boolean]"==l.call(n)},j.isNull=function(n){return null===n},j.isUndefined=function(n){return n===void 0},j.has=function(n,t){return f.call(n,t)},j.noConflict=function(){return n._=t,this},j.identity=function(n){return n},j.times=function(n,t,r){for(var e=Array(Math.max(0,n)),u=0;n>u;u++)e[u]=t.call(r,u);return e},j.random=function(n,t){return null==t&&(t=n,n=0),n+Math.floor(Math.random()*(t-n+1))};var I={escape:{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","/":"&#x2F;"}};I.unescape=j.invert(I.escape);var T={escape:new RegExp("["+j.keys(I.escape).join("")+"]","g"),unescape:new RegExp("("+j.keys(I.unescape).join("|")+")","g")};j.each(["escape","unescape"],function(n){j[n]=function(t){return null==t?"":(""+t).replace(T[n],function(t){return I[n][t]})}}),j.result=function(n,t){if(null==n)return void 0;var r=n[t];return j.isFunction(r)?r.call(n):r},j.mixin=function(n){A(j.functions(n),function(t){var r=j[t]=n[t];j.prototype[t]=function(){var n=[this._wrapped];return a.apply(n,arguments),z.call(this,r.apply(j,n))}})};var N=0;j.uniqueId=function(n){var t=++N+"";return n?n+t:t},j.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var q=/(.)^/,B={"'":"'","\\":"\\","\r":"r","\n":"n","	":"t","\u2028":"u2028","\u2029":"u2029"},D=/\\|'|\r|\n|\t|\u2028|\u2029/g;j.template=function(n,t,r){var e;r=j.defaults({},r,j.templateSettings);var u=new RegExp([(r.escape||q).source,(r.interpolate||q).source,(r.evaluate||q).source].join("|")+"|$","g"),i=0,a="__p+='";n.replace(u,function(t,r,e,u,o){return a+=n.slice(i,o).replace(D,function(n){return"\\"+B[n]}),r&&(a+="'+\n((__t=("+r+"))==null?'':_.escape(__t))+\n'"),e&&(a+="'+\n((__t=("+e+"))==null?'':__t)+\n'"),u&&(a+="';\n"+u+"\n__p+='"),i=o+t.length,t}),a+="';\n",r.variable||(a="with(obj||{}){\n"+a+"}\n"),a="var __t,__p='',__j=Array.prototype.join,"+"print=function(){__p+=__j.call(arguments,'');};\n"+a+"return __p;\n";try{e=new Function(r.variable||"obj","_",a)}catch(o){throw o.source=a,o}if(t)return e(t,j);var c=function(n){return e.call(this,n,j)};return c.source="function("+(r.variable||"obj")+"){\n"+a+"}",c},j.chain=function(n){return j(n).chain()};var z=function(n){return this._chain?j(n).chain():n};j.mixin(j),A(["pop","push","reverse","shift","sort","splice","unshift"],function(n){var t=e[n];j.prototype[n]=function(){var r=this._wrapped;return t.apply(r,arguments),"shift"!=n&&"splice"!=n||0!==r.length||delete r[0],z.call(this,r)}}),A(["concat","join","slice"],function(n){var t=e[n];j.prototype[n]=function(){return z.call(this,t.apply(this._wrapped,arguments))}}),j.extend(j.prototype,{chain:function(){return this._chain=!0,this},value:function(){return this._wrapped}})}.call(this);DAB={interludes:[],essays:[]};DAB.App=function(){var $window=$(window),$body=$("body"),$welcome=$("#welcome-panes"),$panes=$(".pane"),$interludes=$(".interlude"),$interludeXs=$(".interlude .x"),$interactives=$(".interactive"),$overlaysWrapper=$("#overlays"),$overlays=$(".overlay"),$overlayOpeners=$(".overlay-opener"),$overlayX=$("#overlays .x"),$main=$("#main-content"),$menus=$(".menu"),$dropdowns=$(".persist-dropdown"),$mainTitle=$("#main-content h1.project-title"),$header=$("#primary-header"),$fbButton=$(".facebook"),$primaryNav=$("#primary-nav"),$interludeLinks=$("#primary-nav li"),$namesWrapper=$("#names-wrapper");var sizes={height:$window.height(),width:$window.width()};var activeInterlude,activeEssay;var preventScrollEvents;var gateLetterScale=d3.scale.linear().domain([0,$mainTitle.height()]).range([0,100]),opacityScale=d3.scale.linear().domain([0,sizes.height*2]).range([1,0]);var main=$main[0],title=$mainTitle[0],names=document.getElementById("names-wrapper");var st,amount,opacity;var animateOpeningWords=function(e){st=main.scrollTop;if(st<sizes.height*2){amount=gateLetterScale(st);opacity=opacityScale(st);nameOpacity=Math.max(0,Math.min(2*opacity,1));names.style.opacity=nameOpacity;title.style.letterSpacing=amount+"px";title.style.textShadow="0px 0px "+amount+"px #8c7c80";title.style.lineHeight=100+amount+"%";title.style.opacity=opacity}};var sizeAndPositionElements=function(e){sizes.height=$(window).height();sizes.width=$(window).width();$panes.height(sizes.height);$interludes.height(sizes.height);$interactives.height(sizes.height);$welcome.height($welcome.find(".pane").length*sizes.height);if(sizes.width>640){$main.off("scroll").on("scroll",_.throttle(animateOpeningWords,60))}else{$("#names-wrapper").css("opacity",0)}if(preventScrollEvents){$main.off("scroll")}};var toggleMenu=function(e){var $menu=$(this);$menu.toggleClass("active");var dropdownClass=$menu.data("persist-dropdown");var $dropdown=$("."+dropdownClass);$dropdown.toggleClass("active");e.stopPropagation()};var closeMenus=function(e){$menus.removeClass("active");$dropdowns.removeClass("active")};var openOverlay=function(e){$("#"+$(this).data("overlay")).addClass("active");$overlaysWrapper.addClass("active");$main.addClass("blur");$header.addClass("blur")};var closeOverlay=function(e){$overlaysWrapper.removeClass("active");$overlays.removeClass("active");$main.removeClass("blur");$header.removeClass("blur")};var openShareDialog=function(e){FB.ui({method:"share",href:window.location.href},function(response){})};var activateInterlude=function(e){activeInterlude.wrapper.addClass("active");activeInterlude.activate()};var deactivateInterlude=function(e){activeInterlude.wrapper.removeClass("active");activeInterlude.deactivate()};var createRoutes=function(){var routes={};routes["/"]=function(){_.each(DAB.interludes,function(interlude){interlude.off()});$welcome.removeClass("inactive");$namesWrapper.removeClass("inactive");preventScrollEvents=false;$window.trigger("resize");$main.css("opacity",1);activeInterlude=undefined;$primaryNav.find("li").removeClass("inactive")};_.each(DAB.interludes,function(interlude){routes[interlude.path]=function(){$main.css("opacity",0);$main.scrollTop(0);$welcome.addClass("inactive");$namesWrapper.addClass("inactive");if(activeInterlude){deactivateInterlude();activeInterlude.off()}if(activeEssay){activeEssay.off()}interlude.on();activeInterlude=interlude;preventScrollEvents=true;$window.trigger("resize");$main.css("opacity",1);$primaryNav.find("li").removeClass("inactive");$primaryNav.find("."+interlude.title.toLowerCase().split(" ").join("-")).addClass("inactive")}});_.each(DAB.essays,function(essay){routes[essay.path]=function(){$main.css("opacity",0);$main.scrollTop(0);$welcome.addClass("inactive");$namesWrapper.addClass("inactive");if(activeInterlude){deactivateInterlude();activeInterlude.off()}if(activeEssay){activeEssay.off()}essay.on();activeEssay=essay;preventScrollEvents=true;$window.trigger("resize");$main.css("opacity",1);$primaryNav.find("li").removeClass("inactive");$primaryNav.find("."+essay.title.toLowerCase().split(" ").join("-")).addClass("inactive")}});return routes};this.on=function(){d3.json("/names.json",function(names){var ul=d3.select("#names-wrapper");ul.selectAll("li.name").data(names).enter().append("li").classed("name",true).text(function(d){return d.Name})});$menus.on("click",toggleMenu);$overlayOpeners.on("click",openOverlay);$overlayX.on("click",closeOverlay);$window.on("resize",sizeAndPositionElements);$interludes.on("click",activateInterlude);$interludeXs.on("click",function(e){e.stopPropagation();deactivateInterlude($(this).parent())});$fbButton.on("click",openShareDialog);$body.on("click",closeMenus);$interludeLinks.on("click",function(e){DAB.history.navigate($(this).data("href"))});DAB.router=new DAB.Router({routes:createRoutes()});DAB.history.start()}};$(document).ready(function(){DAB.app=new DAB.App;DAB.app.on()});DAB.Router=function(options){var routes=options.routes;var check=function(){var currentRoute=window.location.pathname;if(currentRoute){routes[currentRoute]()}else{throw new Error("No route with that name.")}};$(window).on("dab-navigate",check)};DAB.history={trigger:function(){$(window).trigger("dab-navigate")},navigate:function(path){window.history.pushState({path:true},"",path);this.trigger()},start:function(){this.trigger();window.addEventListener("popstate",this.trigger,false)}};DAB.Essay=function(options){var that=this;this.wrapper=options.el;this.path=options.path;this.title=options.title;this.on=function(){that.wrapper.show()};this.off=function(){that.wrapper.hide()}};DAB.Interlude=function(options){var that=this;if(_.isUndefined(options)||typeof options!=="object"){throw new Error("You must pass in an options object to DAB.Interlude")}if(_.isUndefined(options.wrapper)){throw new Error("You must provide a wrapper to latch on to.")}else{this.wrapper=options.wrapper;this.wrapper.append('<div class="interactive"></div>');this.el=this.wrapper.find(".interactive")}if(_.isUndefined(options.url)){throw new Error("You must provide a url")}else{this.url=options.url}if(_.isUndefined(options.title)){throw new Error("Interludes need titles.")
}else{this.title=options.title}this.path=options.path;if(_.isUndefined(this.path)){throw new Error("Interludes need paths.")}this.subtitle=_.isUndefined(options.subtitle)?"":options.subtitle;if(_.isUndefined(options.build)||typeof options.build!=="function"){this.build=function(){}}else{this.build=options.build}if(_.isUndefined(options.activate)||_.isUndefined(options.deactivate)){throw new Error("Interludes must be able to be activated and deactivated")}else{this.activate=options.activate;this.deactivate=options.deactivate}this.createSharedElements=function(){that.svg=d3.select(that.el[0]).append("svg").attr("width",that.el.width()).attr("height",that.el.height())};this.requestData=function(){d3.json(this.url,function(data){that.build(data)})};this.on=function(){that.requestData();that.wrapper.show()};this.off=function(){that.wrapper.hide();that.wrapper.find(".interactive").empty()}};util={};util.inherits=function(subClass,superClass){function tempCtor(){}tempCtor.prototype=superClass.prototype;subClass.superClass_=superClass.prototype;subClass.prototype=new tempCtor;subClass.prototype.constructor=subClass;subClass.prototype.base=function(me,methodName,var_args){var args=Array.prototype.slice.call(arguments,2);return superClass.prototype[methodName].apply(me,args)}};DAB.interludes.push(new DAB.Interlude({wrapper:$("#a-narrow-practice"),url:"a-narrow-practice.json",path:"/a-narrow-practice",title:"A Narrow Practice",subtitle:"Mapping executions since 1977",activate:function(){this.svg.selectAll("g").attr("filter","")},deactivate:function(){this.svg.selectAll("g").attr("filter","");this.svg.selectAll("g").attr("filter","url(#a-narrow-practice-blur)")},build:function(topology){var that=this;var topTenActive;that.createSharedElements();var defs=that.svg.append("defs");var filter=defs.append("filter").attr("id","a-narrow-practice-blur");filter.append("feGaussianBlur").attr("in","SourceGraphic").attr("stdDeviation",10);var c=d3.scale.ordinal().domain([0,1,2,3,4]).range(["rgb(70,62,64)","rgb(68,70,79)","rgb(58,86,106)","rgb(37,117,159)","rgb(0,174,255)"]);var cRed=d3.scale.ordinal().domain([0,1,2,3,4]).range(["rgb(70,62,64)","rgb(79,70,68)","rgb(106,86,58)","rgb(159,117,37)","rgb(255,174,0)"]);var range=function(input){if(!input||input==="false"||input===0){return 0}else if(input<=1){return 1}else if(input<=10){return 2}else if(input<=50){return 3}else{return 4}};var createLegend=function(){that.el.append('<table class="legend">'+"<tr>"+'<td class="colorblock"></td>'+"<td>0 executions</td>"+"</tr>"+"<tr>"+'<td class="colorblock"></td>'+"<td>1 execution</td>"+"</tr>"+"<tr>"+'<td class="colorblock"></td>'+"<td>2 to 10 executions</td>"+"</tr>"+"<tr>"+'<td class="colorblock"></td>'+"<td>11 to 49 executions</td>"+"</tr>"+"<tr>"+'<td class="colorblock"></td>'+"<td>50 or more executions</td>"+"</tr>"+"</table>");var table=that.el.find("table.legend");for(var i=0;i<table.find("td.colorblock").length;i++){table.find("td.colorblock").eq(i).css("background-color",c(i))}};createLegend();var createOverlayAndToggle=function(){that.el.append('<div class="a-narrow-practice-buttons">'+'<button class="a-narrow-practice-button top-ten-button">toggle top ten counties</button>'+'<button class="a-narrow-practice-button a-narrow-practice-more-button">learn more about this map</button>'+"</div>");$("button.top-ten-button").on("click",function(e){topTenActive=topTenActive?false:true;that.svg.selectAll("path.top-ten").style("fill",function(d){return topTenActive?cRed(range(d.properties.count)):c(range(d.properties.count))})});$(".a-narrow-practice-overlay").remove();$("body").append('<div class="a-narrow-practice-overlay">'+"<h1>A few words about this map</h1>"+"<p>The top ten counties are in three states, with six of the ten in Texas. Though Texas has delivered more death sentences than any other state, Florida and California are not far behind. As of October 1, 2014, California has the largest death row population of any state; however, California has only executed 13 people since the ban was lifted.</p>"+"<p>The top 10 counties and their most populous city are Harris (Houston, TX), Dallas (Dallas, TX), Oklahoma (Oklahoma City, OK), Tarrant (Fort Worth, TX), Bexar (San Antonio, TX), Montgomery (Conroe, TX), Tulsa (Tulsa, OK), Jefferson (Beaumont, TX), Saint Louis (Florissant, MO), Saint Louis City (Saint Louis, MO).</p>"+"<p>This map does not include federal or military executions.</p>"+"</div>");$("button.a-narrow-practice-more-button").on("click",function(e){$("#main-content, #primary-header").addClass("blur");$(".a-narrow-practice-overlay").addClass("active");$(".a-narrow-practice-overlay").on("click",function(e){$(this).removeClass("active");$("#main-content, #primary-header").removeClass("blur")})})};createOverlayAndToggle();var scale=d3.scale.ordinal().domain([0,10,100,1e3]).range(["rgb(0,0,0)","rgb(50,50,50)","rgb(100,100,100)","rgb(255,255,255)"]);var projection=d3.geo.albersUsa().scale(that.el.width>=768?that.el.width()+300:that.el.width()+100).translate([that.el.width()/2,that.el.height()/2]);var path=d3.geo.path().projection(projection);that.svg.append("g").attr("class","counties").selectAll("path.county").data(topojson.feature(topology,topology.objects.counties).features).enter().append("path").attr("id",function(d){return"fips-"+d.id}).attr("d",path).attr("class",function(d){if(d.properties.count!=="false"&&d.properties.count>0){var classString="executioner";if(d.properties.topTen==="true"){classString+=" top-ten"}if(d.properties.topOnePercent==="true"){classString+=" top-one-percent"}if(d.properties.topTenPercent==="true"){classString+=" top-ten-percent"}return classString}}).classed("county",true).style("fill",function(d){return c(range(d.properties.count))});that.svg.append("g").attr("class","states").selectAll("path.state").data(topojson.feature(topology,topology.objects.states).features).enter().append("path").attr("d",path).attr("id",function(d){return"fips-"+d.id}).classed("state",true);that.svg.select("g.states").attr("filter","url(#a-narrow-practice-blur)");that.svg.select("g.counties").attr("filter","url(#a-narrow-practice-blur)");$(".executioner").css("cursor","pointer").on("mouseover",function(e){var d=d3.select(this).datum();if(d.properties.count!=="false"&&d.properties.count>0){var name=d.properties.county,count=d.properties.count,state=d.properties.state;if(that.el.find(".inspector").length===0){that.el.append('<ul class="inspector">'+"<li>"+name+"</li>"+"<li>"+count+" executions</li>"+"</ul>")}else{var inspector=that.el.find(".inspector")}var inspector=that.el.find(".inspector");inspector.css({top:e.clientY-that.el.offset().top-100,left:e.clientX-that.el.offset().left-inspector.width()/2})}}).on("mouseout",function(e){that.el.find(".inspector").remove()})}}));DAB.interludes.push(new DAB.Interlude({wrapper:$("#how-we-kill"),url:"/how-we-kill.json",path:"/how-we-kill",title:"How We Kill",subtitle:"Methods of Execution from 1776 to 2014",activate:function(){this.svg.select("g.guts").attr("filter","")},deactivate:function(){this.svg.select("g.guts").attr("filter","");this.svg.select("g.guts").attr("filter","url(#how-we-kill-blur)");this.removeFauxGif()},build:function(data){var that=this;that.createSharedElements();var defs=that.svg.append("defs");var filter=defs.append("filter").attr("id","how-we-kill-blur");filter.append("feGaussianBlur").attr("in","SourceGraphic").attr("stdDeviation",10);var colorIndex={"lethal injection":0,electrocution:1,"gas chamber":2,"firing squad":3,hanging:4,other:5};var methods=d3.keys(colorIndex);var c=d3.scale.ordinal().domain([5,4,3,2,1,0]).range(["rgb(255,149,207)","rgb(255,0,174)","rgb(255,207,149)","rgb(255,174,0)","rgb(149,207,255)","rgb(0,174,255)"]);var sizes={width:that.el.width(),height:that.el.height(),top:55,right:44,bottom:88,left:44};sizes.cwidth=sizes.width-sizes.left-sizes.right,sizes.cheight=that.el.height()-sizes.top-sizes.bottom;var guts=that.svg.append("g").attr("class","guts").attr("width",sizes.cwidth).attr("height",sizes.cheight).attr("transform","translate("+sizes.left+","+sizes.top+")");that.svg.select("g.guts").attr("filter","url(#how-we-kill-blur)");var createLegend=function(el){el.append('<table class="legend"></table>');_.each(methods,function(method){el.find("table.legend").append("<tr>"+'<td style="background-color:'+c(method)+';" class="colorblock"></td>'+"<td>"+method+"</td>"+"</tr>")})};createLegend(that.el);var isSuperSmall=function(){return $(window).width()<=640?true:false};var years=[];var ticks=[];for(var i=1776;i<=2014;i++){years.push(i+"");var spacer=isSuperSmall?25:10;if((i-1776)%spacer===0){ticks.push(i+"")}else{ticks.push("")}}var x=d3.scale.ordinal().domain(years).rangeBands([0,sizes.cwidth]),y=d3.scale.linear().domain([200,0]).range([0,sizes.cheight]);var xAxis=d3.svg.axis().scale(x).orient("bottom").tickValues(ticks);guts.append("g").attr("class","x-axis");guts.select("g.x-axis").call(xAxis).attr("transform","translate(0,"+sizes.cheight+")");var yAxis=d3.svg.axis().scale(y).orient("left").tickSize(-sizes.cwidth);guts.append("g").attr("class","y-axis");guts.select("g.y-axis").call(yAxis);var stack=d3.layout.stack();var stackedData=stack(data);var groups=guts.selectAll("g.layer").data(stackedData).enter().append("g").classed("layer",true);var rects=groups.selectAll("rect").data(function(d){return d}).enter().append("rect").attr("x",function(d){return x(d.x)}).attr("y",function(d){return y(d.y0+d.y)}).attr("height",function(d){return y(d.y0)-y(d.y0+d.y)}).attr("width",function(d){return x.rangeBand()}).style("fill",function(d){return c(d.method)});var isSmall=function(){return $(window).width()<=1300?true:false};var generateFauxGif=function(){$("body").append('<div class="how-we-kill-gifs">'+'<button class="x"></button>'+'<div class="svgs-wrapper">'+'<h1 class="year"></h1>'+"</div>"+"<nav>"+'<button class="rewind">step back</button>'+'<button class="pause-play"><span class="pause">pause</span><span class="play">play</span></button>'+'<button class="fast-forward">step forward</button>'+"</nav>"+'<p class="explanation">In this chart, each year displays the ten previous years&rsquo; data, excluding the decade-long moratorium. You can use the controls below to step through time or simply watch it play.'+"</div>");createLegend($(".how-we-kill-gifs"));rects.transition().duration(500).attr("width",1);rects.transition().delay(500).duration(500).attr("height",0).attr("y",sizes.height);var r=isSmall()?160:320;var plans=[];for(var i=1776;i<2014;i+=1){if(i>=1968&&i<=1976){}else{plans.push({start:i-9-1776,end:i+1-1776})}}var datas=[];_.each(plans,function(plan,i){var counts=[];_.each(data,function(methodArray,j){var count=0;var method=methodArray[0].method;for(var k=plan.start;k<plan.end;k++){if(methodArray[k]){count+=methodArray[k].y}}counts.push({method:method,count:count})});datas.push({start:plan.start+1776,end:plan.end+1776,counts:counts})});_.each(datas,function(datum){var svg=d3.select($(".how-we-kill-gifs .svgs-wrapper")[0]).append("svg").attr("class","pie-svg").data([datum.counts]).attr("width",r*2).attr("height",r*2).append("g").attr("transform","translate("+r+","+r+")");var arc=d3.svg.arc().outerRadius(r).innerRadius(r*(3/8));var pie=d3.layout.pie().sort(function(a,b){colorIndex[a.method]>colorIndex[b.method]?1:-1}).value(function(d){return d.count});var arcs=svg.selectAll("g.slice").data(pie).enter().append("g").attr("class","slice");var paths=arcs.append("path").attr("fill",function(d,i){return c(methods[i])}).attr("d",arc)});var index=0;var svgs=d3.select(".how-we-kill-gifs").selectAll("svg");var h1=d3.select(".how-we-kill-gifs").select("h1.year");var gifTimer;var run=function(){gifTimer=setInterval(function(){index++;if(index>svgs[0].length){index=0;clearInterval(gifTimer);setTimeout(run,1e3)}svgs.classed("active",false);svgs.each(function(d,i){if(i===index){d3.select(this).classed("active",true);h1.text(datas[i].end)}})},120)};run();setTimeout(function(){$(".how-we-kill-gifs").addClass("active");$(".how-we-kill-gifs .pause-play").on("click",function(){if($(this).parent().hasClass("paused")){run()}else{clearInterval(gifTimer)}$(this).parent().toggleClass("paused")});$(".how-we-kill-gifs .rewind").on("click",function(){if(!$(this).parent().hasClass("paused")){$(this).parent().toggleClass("paused")}clearInterval(gifTimer);index--;if(index<0){index=svgs[0].length}svgs.classed("active",false);svgs.each(function(d,i){if(i===index){d3.select(this).classed("active",true);h1.text(datas[i].end)}})});$(".how-we-kill-gifs .fast-forward").on("click",function(){if(!$(this).parent().hasClass("paused")){$(this).parent().toggleClass("paused")}clearInterval(gifTimer);index++;if(index>svgs[0].length){index=0}svgs.classed("active",false);svgs.each(function(d,i){if(i===index){d3.select(this).classed("active",true);h1.text(datas[i].end)}})});that.el.find(".legend").addClass("hidden");$(".how-we-kill-gifs .x").on("click",that.removeFauxGif)},1e3)};that.removeFauxGif=function(){$(".how-we-kill-gifs").removeClass("active");rects.transition().duration(500).attr("height",function(d){return y(d.y0)-y(d.y0+d.y)}).attr("y",function(d){return y(d.y0+d.y)});rects.transition().delay(500).duration(500).attr("width",function(d){return x.rangeBand()});that.el.find(".legend").removeClass("hidden");setTimeout(function(){$(".how-we-kill-gifs").remove()},500)};that.el.append('<button class="how-we-kill-button faux-gif-button">Step through time</button>');that.el.find(".faux-gif-button").on("click",generateFauxGif)}}));DAB.interludes.push(new DAB.Interlude({wrapper:$("#last-words"),url:"last-words.json",path:"/last-words",title:"Last Words",subtitle:"Final Statements of the Condemned in Texas",activate:function(){d3.selectAll("g.bubble-wrapper").attr("filter","")},deactivate:function(){d3.selectAll("g.bubble-wrapper").attr("filter","");d3.selectAll("g.bubble-wrapper").attr("filter","url(#last-words-blur)")},build:function(data){var that=this;$(".words-overlay").remove();$("body").append('<div class="words-overlay">'+'<div class="words">'+"<h1></h1>"+'<div class="statement"></div>'+"</div>"+"</div>");that.createSharedElements();var paragraphize=function(input){input="<p>"+input+"</p>";input.replace(/<br \/>/g,"</p><p>");return input};var data={name:"words",children:data};var pack=d3.layout.pack().sort(null).size([that.el.width(),that.el.height()]).value(function(d){return d.count});var nodes=pack.nodes(data);fontScaleRangeArray=$(window).width()>640?[8,60]:[6,20];var fontScale=d3.scale.linear().domain([d3.min(nodes[0].children,function(d){return d.r}),d3.max(nodes[0].children,function(d){return d.r})]).range(fontScaleRangeArray);var defs=that.svg.append("defs");var filter=defs.append("filter").attr("id","last-words-blur");filter.append("feGaussianBlur").attr("in","SourceGraphic").attr("stdDeviation",10);that.svg.selectAll("g.bubble-wrapper").data(nodes).enter().append("g").attr("class","bubble-wrapper").classed("parent",function(d){return d.children?true:false}).attr("transform",function(d){return"translate("+d.x+","+d.y+")"}).attr("filter","url(#last-words-blur)");var padding=$(window).width()>640?3:1;that.svg.selectAll("g.bubble-wrapper").append("circle").classed("bubble",true).attr("r",function(d){return d.r-padding});that.svg.selectAll("g.bubble-wrapper").append("text").text(function(d){return d.word}).style("font-size",function(d){return fontScale(d.r)}).attr("transform",function(d){var yPosition=fontScale(d.r)/4;return"translate(0,"+yPosition+")"});that.svg.selectAll("g.bubble-wrapper").on("click",function(d){ga("send","event","word bubble","click",d.word);var openTime=Date.now();var d3el=d3.select(this);$("#main-content, #primary-header").addClass("blur");d3el.classed("active",true);$(".words-overlay").find("h1").text(d.name);$(".words-overlay").find(".statement").html(paragraphize(d.statement));$(".words-overlay").addClass("active");$(".words-overlay").on("click",function(e){$(this).removeClass("active");var elapsed=Date.now()-openTime;ga("send","event","word bubble","closed",d.word,elapsed);d3el.classed("active",false);$("#main-content, #primary-header").removeClass("blur")})})}}));DAB.Interlude.TimeMap=function(options){this.base(this,"constructor",options);this.currentYear=1977;this.states={}};util.inherits(DAB.Interlude.TimeMap,DAB.Interlude);DAB.Interlude.TimeMap.prototype.render=function(data){var topology=data.map;this.data=data.data;this.createSharedElements();var defs=this.svg.append("defs");var filter=defs.append("filter").attr("id","when-they-stopped-blur");filter.append("feGaussianBlur").attr("in","SourceGraphic").attr("stdDeviation",10);var domain=["death-sentence","execution","commutation","exoneration","last-exectuion"];this.colorScale=d3.scale.ordinal().domain(domain).range(["rgb(70,62,64)","rgb(68,70,79)","rgb(58,86,106)","rgb(37,117,159)","rgb(0,174,255)"]);this.durationScale=d3.scale.ordinal().domain(domain).range([500,900,1200,1500,2e3]);var cRed=d3.scale.ordinal().domain([0,1,2,3,4]).range(["rgb(70,62,64)","rgb(79,70,68)","rgb(106,86,58)","rgb(159,117,37)","rgb(255,174,0)"]);this.createOverlay();var projection=d3.geo.albersUsa().scale(this.el.width>=768?this.el.width()+300:this.el.width()+100).translate([this.el.width()/2,this.el.height()/2]);var path=d3.geo.path().projection(projection);this.svg.append("g").attr("class","states").selectAll("path.state").data(topojson.feature(topology,topology.objects.states).features).enter().append("path").attr("id",function(d){return"state-code-"+d.properties.abbreviation}).attr("stroke",function(d){return"rgb(100,100,100)"}).attr("stroke-width",2).attr("d",path).classed("state",true).each(_.bind(function(d){this.states[d.properties.abbreviation]={};this.states[d.properties.abbreviation].centroid=path.centroid(d);this.states[d.properties.abbreviation].bounds=path.bounds(d)},this));this.svg.select("g.states").attr("filter","url(#when-they-stopped-blur)")};DAB.Interlude.TimeMap.prototype.createOverlay=function(){this.el.append('<div class="when-they-stopped-buttons">'+'<button class="when-they-stopped-button when-they-stopped-play-button">Step through time</button>'+'<button class="when-they-stopped-button when-they-stopped-more-button">learn more about this map</button>'+"</div>");$(".when-they-stopped-overlay").remove();$("body").append('<div class="when-they-stopped-overlay">'+"<h1>A few words about this map</h1>"+"</div>");$("button.when-they-stopped-more-button").on("click",function(e){$("#main-content, #primary-header").addClass("blur");$(".when-they-stopped-overlay").addClass("active");$(".when-they-stopped-overlay").on("click",function(e){$(this).removeClass("active");$("#main-content, #primary-header").removeClass("blur")})});$("button.when-they-stopped-play-button").on("click",_.bind(this.play,this))};DAB.Interlude.TimeMap.SPEED=3e3;DAB.Interlude.TimeMap.prototype.play=function(){console.log("play called");this.intervalId=setInterval(_.bind(this.animate,this),DAB.Interlude.TimeMap.SPEED)};DAB.Interlude.TimeMap.prototype.animate=function(){this.animateYear(this.currentYear);if(this.currentYear<2014){this.currentYear++;console.log(this.currentYear)}else{this.endAnimation()}};DAB.Interlude.TimeMap.prototype.animateYear=function(year){var events=_.clone(this.data[year]);var millisecondsPerEvent=DAB.Interlude.TimeMap.SPEED/events.length;var startTime;var displayedIndex=0;var animateFrame=_.bind(function(timestamp){if(!startTime){startTime=timestamp}var timeSinceFirstFrame=timestamp-startTime;var numEventsToDisplay=timeSinceFirstFrame/millisecondsPerEvent;for(;displayedIndex<numEventsToDisplay&&displayedIndex<events.length;displayedIndex++){this.renderEvent(events[displayedIndex])}if(displayedIndex<events.length){this.currentAnimation=requestAnimationFrame(animateFrame)}},this);this.currentAnimation=requestAnimationFrame(animateFrame)};DAB.Interlude.TimeMap.prototype.renderEvent=function(e){if(!this.states[e.state.toUpperCase()]){console.log("Can't place ",e);return}var location=this.getLocationForState(e.state.toUpperCase());this.svg.append("circle").attr("cx",function(){return location[0]}).attr("cy",function(d){return location[1]}).attr("fill",this.colorScale(e.type)).attr("r",0).transition().attr("r",50).style("opacity",0).duration(this.durationScale(e.type)).remove()};DAB.Interlude.TimeMap.prototype.getLocationForState=function(state){var centroid=this.states[state].centroid;var boundingBox=this.states[state].bounds;pctFromCenter=.7;var xBounds=[boundingBox[0][0]-centroid[0],boundingBox[1][0]-centroid[0]];var yBounds=[boundingBox[0][1]-centroid[1],boundingBox[1][1]-centroid[1]];var perturbation=[(Math.random()*xBounds[1]+xBounds[0])*pctFromCenter,(Math.random()*yBounds[1]+yBounds[0])*pctFromCenter];var location=[centroid[0]+perturbation[0],centroid[1]+perturbation[1]];console.log(document.elementFromPoint(location[0],location[1]));return location};DAB.Interlude.TimeMap.prototype.endAnimation=function(){if(this.intervalId){clearInterval(this.intervalId);this.intervalId=null}};DAB.interludes.push(new DAB.Interlude.TimeMap({wrapper:$("#when-they-stopped"),url:"when-they-stopped.json",path:"/when-they-stopped",title:"When They Stopped",subtitle:"Charting death row populations since 1977",activate:function(){this.svg.selectAll("g").attr("filter","")},deactivate:function(){this.svg.selectAll("g").attr("filter","");this.svg.selectAll("g").attr("filter","url(#when-they-stopped-blur)")},build:DAB.Interlude.TimeMap.prototype.render}));DAB.essays.push(new DAB.Essay({el:$("#gary-gilmore"),path:"/essays/gary-gilmore",title:"Gary Gilmore"}));DAB.essays.push(new DAB.Essay({el:$("#velma-barfield"),path:"/essays/velma-barfield",title:"Velma Barfield"}));
